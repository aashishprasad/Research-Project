...
data <- read.csv("D:/DA/Semester_3/Research Project/Dataset/final_video_game_dataset_2.csv")
data <- data[,-c(1)]
#################################################################
...
write.csv(game_df, file = "D:/DA/Semester_3/Research Project/Dataset/boruta_result_dataset_2.csv",fileEncoding = 'UTF-8')
selected_game_df <- df[,c(1,2,6,8,12:15,17,19,25,27,28,32:44,56,58,62:64,70,101,120,122,125:127,131,170,176,190,192,209,212,215,217,220,224,226,235,236)]
...
#RMSE 1.519063, R2 0.1141036 Boruta
#RMSE 1.467499, R2 0.2081404
...
#RMSE 1.606727, R2 0.05660941 Boruta
#RMSE 1.56455, R2 0.1030974
...
#RMSE 1.5761, R2 0.04482876 #Boruta
#RMSE 1.492866, R2 0.1430505
